...
import com.rova.accountservice.services.impl.IJwtService;
...
import static com.rova.accountservice.util.Constants.EntityColumns.ID;
import static com.rova.accountservice.util.JwtTokenUtils.TokenType.REFRESH;
...
public class JwtTokenUtils {
    ...
    private JwtBuilder buildJwt(IUserDetails userDetails, Map<String, Object> headers) throws JwtException, CommonsException {
        ...
        // TODO: commenting the line below as product requires we allow login with default password for now
        // if (SignupSource.STOREFRONT.equals(userDetails.getSource()) && !userDetails.isPasswordChanged())
        // throw new JwtException("user.default_password", HttpStatus.PRECONDITION_FAILED);
